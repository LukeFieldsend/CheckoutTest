namespace Checkout
{
    public class ApiUrls
    {
        ...
        public static string Cards
            => _cardApiUri ?? (_cardApiUri = string.Concat(AppSettings.BaseApiUri, "/customers/{0}/cards"));

        public static string Drink
          => _drinkApiUri ?? (_drinkApiUri = string.Concat(AppSettings.BaseOfficeApiUri, "/api/drink"));
